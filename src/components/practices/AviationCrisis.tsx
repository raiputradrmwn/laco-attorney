...
import { Plane, AlertTriangle, Globe } from "lucide-react";
import { Header } from "@/components/layout/Header";
import { AnimateIn } from "@/components/AnimateIn";
import { AnimateText } from "@/components/AnimateText";
import { useTranslations } from "next-intl";

export function AviationCrisis() {
    const t = useTranslations('PracticePages.AviationCrisis');
        ...
        <main className="bg-black text-white min-h-screen selection:bg-white selection:text-black">
            ...
            <div className="pt-24 md:pt-40 pb-20 md:pb-24">
                <div className="container mx-auto px-4 md:px-6">
                    <header className="mb-16 md:mb-32">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-24 items-end">
                            <div>
                                ...
                                <div className="text-4xl sm:text-6xl md:text-8xl font-serif mb-6 md:mb-8 italic tracking-tighter leading-none text-balance">
                    ...
                    <section className="grid grid-cols-1 lg:grid-cols-3 gap-10 md:gap-16 mb-24 md:mb-40">
                        <div className="lg:col-span-2 space-y-8 md:space-y-12">
                            ...
                            <div className="space-y-6 text-zinc-400 text-base md:text-lg leading-relaxed font-light">
                                <AnimateIn from="bottom" delay={0.7}>
                                    <p>
                                        {t('p1')}
                                    </p>
                                </AnimateIn>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 md:gap-12 pt-4 md:pt-8">
                                <AnimateIn from="bottom" delay={0.9} className="space-y-4">
                                ...
                                <AnimateIn from="bottom" delay={1.0} className="space-y-4">
                        ...
                        <AnimateIn from="right" delay={1.1} className="bg-zinc-950 p-8 md:p-12 border border-white/5 h-fit shadow-2xl">
                    ...
                    <AnimateIn from="bottom" threshold={0.5} className="py-16 md:py-24 border-t border-white/10 text-center">
