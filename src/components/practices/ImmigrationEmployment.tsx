...
import { PlaneTakeoff, Users, Briefcase, Globe } from "lucide-react";
import { Header } from "@/components/layout/Header";
import { useTranslations } from "next-intl";

export function ImmigrationEmployment() {
    const t = useTranslations('PracticePages.ImmigrationEmployment');
