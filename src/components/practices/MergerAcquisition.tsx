...
import { Combine, Search, ShieldCheck, TrendingUp } from "lucide-react";
import { Header } from "@/components/layout/Header";
import { useTranslations } from "next-intl";

export function MergerAcquisition() {
    const t = useTranslations('PracticePages.MergerAcquisition');
                    ...
                    <header className="mb-32">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-end">
                            <div>
                                ...
                                <h1 className="text-4xl sm:text-6xl md:text-9xl font-serif mb-8 italic tracking-tighter leading-none text-balance">
                                    {t('title')}
                                </h1>
                            </div>
